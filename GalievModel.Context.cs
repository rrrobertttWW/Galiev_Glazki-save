...
namespace Galiev_Глазки_save
{
    ...
    public partial class GalievSaveEntities : DbContext
    {
        private static GalievSaveEntities _context;
        public static GalievSaveEntities GetContext()
        {
            if (_context == null)
                _context = new GalievSaveEntities();
            return _context;
        }
        public GalievSaveEntities()
            : base("name=GalievSaveEntities")
        {
        }
